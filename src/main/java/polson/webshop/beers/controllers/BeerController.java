...
public class BeerController {
    ...
    @PostMapping
    public ResponseEntity<?> createBeer(Authentication auth, @RequestBody RegBeerDTO regBeerDTO) throws ApiException {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> getBeeryById(@PathVariable("id") Long id) throws ApiException {
        return ResponseEntity
    ...
    public ResponseEntity<?> deleteBeer(Authentication auth, @PathVariable Long beerId) throws ApiException {
        JwtUserDetails userDetails = (JwtUserDetails) auth.getPrincipal();
    ...
    @PutMapping
    public ResponseEntity<?> increaseStock(Authentication auth, @RequestBody StockIncrDTO stockIncrDTO) throws ApiException {
        JwtUserDetails userDetails = (JwtUserDetails) auth.getPrincipal();
        return ResponseEntity
                .status(HttpStatus.OK)
